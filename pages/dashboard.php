                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <ul class="list-inline d-flex justify-content-between justify-content-center mb-0">
                                ...
                                <li class="list-inline-item"><a href="" class="text-muted">Month</a>
                                </li>
                            ...
                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="badge text-danger  bg-danger-subtle font-size-12">Cancel</span>
                                        </td>
                                        <td>
                                            <div class="dropdown">
            ...
            <div class="card-body pt-1">
                ...
                <div class="table-responsive">
                    <table class="table table-centered align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="assets/images/flags/us.jpg" alt="user-image" class="me-3" height="18">US
                                </td>
                                <td>
                                    26,568.84
                                </td>
                            ...
                            <tr>
                                <td><img src="assets/images/flags/germany.jpg" alt="user-image" class="me-3"
                                        height="18">German</td>
                                <td>
                                    36,485.52
                                </td>
                            ...
                            <tr>
                                <td><img src="assets/images/flags/italy.jpg" alt="user-image" class="me-3"
                                        height="18">Italy</td>
                                <td>
                                    17,568.84
                                </td>
                            ...
                            <tr>
                                <td><img src="assets/images/flags/spain.jpg" alt="user-image" class="me-3"
                                        height="18">Spain</td>
                                <td>
                                    75,521.28
                                </td>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-centered align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>1.</td>
                                <td><a href="javascript: void(0);" class="text-body">Iphone 12 Max
                                        Pro</a> </td>
                                <td>
                            ...
                            <tr>
                                <td>2.</td>
                                <td><a href="javascript: void(0);" class="text-body">New Red and White
                                        jacket </a> </td>
                                <td>
                                    <i class="mdi mdi-circle font-size-10 me-1 align-middle text-danger"></i>
                                    Red
                                </td>
                                <td>
                                    Fashion
                                ...
                                <td style="width: 130px;">
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar progress-bar-striped bg-success" role="progressbar"
                                            style="width: 70%" aria-valuenow="70" aria-valuemin="0" aria-valuemax="75">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>3.</td>
                                <td><a href="javascript: void(0);" class="text-body">Latest Series Watch
                                        OS 8</a> </td>
                                <td>
                                    <i class="mdi mdi-circle font-size-10 me-1 align-middle text-primary"></i>
                                    Dark
                                </td>
                                <td>
                                    Electronic
                            ...
                            <tr>
                                <td>4.</td>
                                <td><a href="javascript: void(0);" class="text-body">New Horror Book</a>
                                </td>
                                <td>
                                    <i class="mdi mdi-circle font-size-10 me-1 align-middle text-success"></i>
                                    Green
                                </td>
                                <td>
                                    Book
                                ...
                                <td style="width: 130px;">
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar progress-bar-striped bg-success" role="progressbar"
                                            style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="75">
                                        </div>
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>5.</td>
                                <td><a href="javascript: void(0);" class="text-body">Smart 4k Android
                                        TV</a> </td>
                                <td>
                                    <i class="mdi mdi-circle font-size-10 me-1 align-middle text-primary"></i>
                                    Gray
                                ...
                                <td style="width: 130px;">
                                    <div class="progress" style="height: 6px;">
                                        <div class="progress-bar progress-bar-striped bg-pricing" role="progressbar"
                                            style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="75">
                                        </div>
                                    </div>
                                </td>
                                <td>
